...
int main()
{
  ...
  if (!read_map_data(mapFile,map)) {
	  cout << "Error: Could not open map file: " << mapFile << endl;
	  return -1;
  }
    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2')
    {
      ...
      if (s != "") {
	      ...
	      string sense_observations_y = j[1]["sense_observations_y"];
              ...
              //cout << "DBG (sense_observations_x): " << sense_observations_x << endl;
              //cout << "DBG (sense_observations_y): " << sense_observations_y << endl;
	      ...
	      // TODO #3: Update the weights and resample
              pf.updateWeights(sensor_range, sigma_landmark, noisy_observations, map);

              // TODO #4: RESAMPLE ()
              //cout << "DBG : main() : resample() " << pf.packet_count << " \n";
              pf.resample();
              //cout << "DBG : main() : resample() >> \n";
